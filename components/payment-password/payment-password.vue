		...
		<view class="best-modal-content">
			...
			<view class="digital-keyboard">
				<view class="form_edit clearfix">
					<view class="num" v-for="item in digitalList" :key="item" :class="{'no-num':item === '-1','cancel':item === ''}"
					 @click="getKeyNumber(item)">{{item?item:'取消'}}</view>
				</view>
			</view>
		</view>
	</view>
...
<style>
	...
	.digital-keyboard-modal .num:active{
		background: #f2f2f2;
	}
	...
	.digital-keyboard-modal .num.cancel {
		background-color: #f2f2f2;
		color: #686868;
		font-size: 15px;
	}
